...
FontWidthAddress:
.db 5, 8, 6, 8, 8, 8, 8, 8 ;' ' 0 1 2 3 4 5 6
.db 8, 8, 8, 8, 7, 7, 7, 8 ;  7 8 9 a b c d e
.db 6, 7, 7, 2, 5, 7, 2, 8 ;  f g h i j k l m
.db 7, 7, 7, 7, 6, 7, 6, 7 ;  n o p q r s t u
.db 8, 8, 8, 8, 8, 8, 8, 8 ;  v w x y z A B C
.db 8, 8, 8, 8, 8, 4, 8, 8 ;  D E F G H I J K
.db 7, 8, 8, 8, 8, 8, 8, 8 ;  L M N O P Q R S
.db 8, 8, 8, 8, 8, 8, 8, 8 ;  T U V W X Y Z v2
.db 8, 8, 8, 8, 8, 8, 8, 8 ; v2 - x = : ? + ./.
.db 8, 8, 3, 8, 8, 8, 8, 5 ;  x * !       & ,
.db 4, 3, 3, 3, 4, 8, 8, 8 ;  . . ; ' "
.db 8, 8, 8, 8, 8, 8, 8, 8 
.db 8, 8, 8, 8, 8, 8, 8, 8 
.db 8, 8, 8, 8, 8, 8, 8, 8 
